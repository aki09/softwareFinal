...
`;
  ...
  for (var j in urls) {
    ...
    htmlString += `<div style="display: flex; flex-direction: row; justify-content: space-between; width: 700px;"><div><div style="padding: 3rem 4rem;margin-bottom: 1rem;margin-right:1rem;  border: 2px solid #050049; border-radius: 10px;text-align: center; font-size: 1.5rem">`;
    htmlString += `Array</div> <div style="padding: 3rem 4rem; border: 2px solid #050049; border-radius: 10px; text-align: center;font-size: 1.5rem;margin-right:1rem; ">${errorsByDrone[j].arrayno}</div></div>`;
    htmlString += `<div><div style="padding: 3rem 4rem;margin-bottom: 1rem; border: 2px solid #050049; border-radius: 10px;font-size: 1.5rem; text-align: center;margin-right:1rem;">`;
    htmlString += `Panel</div><div  style="padding: 3rem 4rem; border: 2px solid #050049; border-radius: 10px; text-align: center;font-size: 1.5rem;margin-right:1rem; "> ${errorsByDrone[j].panelno} </div></div>`;
    htmlString += `<div><div style="padding: 3rem 2rem;margin-bottom: 1rem; border: 2px solid #050049; border-radius: 10px; text-align: center;font-size: 1.5rem;">`;
    htmlString += `No. of Errors: </div><div style="padding: 3rem 4rem; border: 2px solid #050049; border-radius: 10px; text-align: center;font-size: 1.5rem; ">${errorsByDrone[j].noer}</div></div>`;
    htmlString += `</div>`;
    htmlString += `</div></div>`;
